	.MODEL	TINY	
ADDR_8255_PA	EQU	0270H	;8255 PA口;行线
ADDR_8255_PB	EQU	0271H	;8255 PA口;行线11
ADDR_8255_C	EQU	273H		;8255控制口
ADDR_273	EQU	230H		;8155 PA口;列线1
ADDR_274	EQU	231H		;8155 PB口;列线2
ROW1		EQU	ADDR_8255_PA	;行线
ROW2		EQU	ADDR_8255_PB	;行线
LINE1	EQU	ADDR_273		;列线1
LINE2	EQU	ADDR_274		;列线1
...
DISP_CH	PROC	NEAR	
	PUSH	CX	
	MOV		CX,8				;延时速度
DISP_CH_1:	CALL	DISP2	;显示字符子程序-》8次
