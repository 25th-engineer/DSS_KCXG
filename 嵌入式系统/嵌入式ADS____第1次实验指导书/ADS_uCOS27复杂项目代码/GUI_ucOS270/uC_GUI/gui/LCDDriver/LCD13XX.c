...
//extern   U32 (*frameBuffer16BitTft240320)[SCR_XSIZE_TFT_240320];
//extern  U16  LCD_Buffer [LCD_XSIZE*LCD_YSIZE];

//extern   void WriteLcdMems( unsigned int off  , unsigned int  c ) ; 
/*
...
*/
// 对 Video RAM 区的读写操作.
//#define LCD_READ_MEM(Off)            LCD_BUFFER[Off/240][Off%240] //&0x0000ffff 

//#define LCD_WRITE_MEM(Off,data)      PutPixel( Off/240,Off%240, data )  
//#define LCD_READ_REG(Off)            0
//#define LCD_WRITE_REG(Off,data)      
